...
import('./navigation-assist.js?v=108.0').catch(error => console.warn('Navigation assist unavailable:', error));
import('./ride-assist.js?v=108.0').catch(error => console.warn('Ride assist unavailable:', error));

// Display a useful recovery screen even if a module fails before game.js runs.
import('./game.js?v=108.0').then(() => {
